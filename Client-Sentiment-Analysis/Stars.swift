    ...
    func starz(number: Int) -> some View {
        ...
        return ZStack{
            if (numberOfStars == 1){
                ...
                star_fill.position(x: 10, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 25, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
            }else if (numberOfStars == 3){
                star_fill.position(x: 10, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 25, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 40, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
            }else if (numberOfStars == 4) {
                star_fill.position(x: 10, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 25, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 40, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 17, y: 20).font(.system(size: 12)).foregroundColor(.yellow)
            }else{
                star_fill.position(x: 10, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 25, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 40, y: 5).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 17, y: 20).font(.system(size: 12)).foregroundColor(.yellow)
                star_fill.position(x: 32, y: 20).font(.system(size: 12)).foregroundColor(.yellow)
            }
        }
    }
}
